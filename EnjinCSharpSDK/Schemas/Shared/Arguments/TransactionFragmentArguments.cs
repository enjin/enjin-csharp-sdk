...
namespace Enjin.SDK.Shared
{
    ...
    {
        public static T WithMeta<T>(this T instance) where T : IVariableHolder<T>
        {
            return instance.SetVariable("withMeta", true);
        }
        
        public static T WithEncodedData<T>(this T instance) where T : IVariableHolder<T>
        {
            return instance.SetVariable("withEncodedData", true);
        }
        
        public static T WithTokenData<T>(this T instance) where T : IVariableHolder<T>
        {
            return instance.SetVariable("withTokenData", true);
        }
        
        public static T WithSignedTxs<T>(this T instance) where T : IVariableHolder<T>
        {
            return instance.SetVariable("withSignedTxs", true);
        }
        
        public static T WithError<T>(this T instance) where T : IVariableHolder<T>
        {
            return instance.SetVariable("withError", true);
        }
        
        public static T WithNonce<T>(this T instance) where T : IVariableHolder<T>
        {
            return instance.SetVariable("withNonce", true);
        }
        
        public static T WithState<T>(this T instance) where T : IVariableHolder<T>
        {
