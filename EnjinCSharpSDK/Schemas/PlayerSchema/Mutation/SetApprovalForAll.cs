...
namespace Enjin.SDK.PlayerSchema
{
    ...
    [PublicAPI]
    public class SetApprovalForAll : GraphqlRequest<SetApprovalForAll>, ITransactionFragmentArguments<SetApprovalForAll>
    {
        /// <summary>
        /// Sole constructor.
        /// </summary>
        public SetApprovalForAll() : base("enjin.sdk.player.SetApprovalForAll")
        {
        }
